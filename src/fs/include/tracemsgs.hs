...
T_SAM_PGRDOBJ_ST	"PgRdObjSt:iotp=%x,off=%x,len=%x"
T_SAM_PGWROBJ_ST	"PgWrObjSt:iotp=%x,off=%x,len=%x"
T_SAM_DIOCOMP		"DioComp:  blk=%x,cnt=%d,bdp=%x"
T_SAM_DIORDOBJ_COMP	"DkRdOComp:iotp=%x,off=%x,len=%x"
T_SAM_DIOWROBJ_COMP	"DkWrOComp:iotp=%x,off=%x,len=%x"
T_SAM_PGRDOBJ_COMP	"PgRdOComp:iotp=%x,off=%x,len=%x"
T_SAM_PGWROBJ_COMP	"PgWrOComp:iotp=%x,off=%x,len=%x"
...
T_SAM_OKMAP		"ObjMap:   off=%x,ct=%x,flag=%x^[$q]"
