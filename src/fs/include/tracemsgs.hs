...
T_SAM_IOCTL		"Ioctl:    rdev=%x,cmd=%x,p=%x"
...
T_SAM_IOCTL_ERR		"D Error:  ino=%d,err=%d,rdev=%x"
...
T_SAM_PSYSCALL		"PrivScall:cmd=%d,cp=%x"
...
T_SAM_SA_CS		"SetArch:  ino=%d,cs_gen=%x,flag=%x"
