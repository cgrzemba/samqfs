...
/*
 * hasam_monitor_start.c - Monitor_start method for SUNW.hasam
 * Starts up /opt/SUNWsamfs/sc/bin/hasam_probe under PMF
 */
...
main(int argc, char *argv[])
{
	...
	/*
	 * Start monitoring SAM
	 */
	rc = hasam_mon_start(&rg);
