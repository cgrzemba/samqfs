 ...
 * Mostly this is for compatibility with regex.c, though it is convenient
...
/* The rest of the code provides a regex.c compatible interface. */
...
#endif
  {
	...
	if (!rx_eclose_nfa (&rxb->rx))
	...
	else
	  {
	    ...
	    /* For compatibility reasons, we need to shove the
