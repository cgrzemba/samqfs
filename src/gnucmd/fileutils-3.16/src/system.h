...
/* SUN defines to build on Solaris 2.5, 2.6, or above */
/* Get the correct open, creat, stat calls and stat structures */

#ifdef linux
#define L_STAT  stat
#define L_LSTAT lstat
#define L_LSEEK lseek
#define L_FSTAT fstat
#define L_OPEN  open
#define L_CREAT creat
#else
#define L_STAT  stat64
#define L_LSTAT lstat64
#define L_LSEEK lseek64
#define L_FSTAT fstat64
#define L_OPEN  open64
#define L_CREAT creat64
#endif /* linux */
