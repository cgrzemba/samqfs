...
// ident	$Id: MediaReportViewBean.java,v 1.5 2008/05/16 19:39:25 am143972 Exp $
...
public class MediaReportViewBean extends CommonViewBeanBase {
    private static String PAGE_NAME = "MediaReport";
    private static String DEFAULT_URL = "/jsp/admin/MediaReport.jsp";

    // children
    public static final String PAGE_TITLE  = "PageTitle";
    public static final String CHILD_STATICTEXT = "StaticText";
    public static final String SERVER_NAME = "ServerName";
    public static final String MEDIA_REPORT_VIEW = "MediaReportView";

    public MediaReportViewBean() {
    ...
    public void registerChildren() {
        ...
        registerChild(MEDIA_REPORT_VIEW, MediaReportView.class);
        TraceUtil.trace3("Entering");
    }
    ...
    public View createChild(String name) {
        ...
        } else if (name.equals(MEDIA_REPORT_VIEW)) {
            return new MediaReportView(this, name);
        } else {
    ...
    public void beginDisplay(DisplayEvent evt) throws ModelControlException {
        ...
        MediaReportView view = (MediaReportView) getChild(MEDIA_REPORT_VIEW);
