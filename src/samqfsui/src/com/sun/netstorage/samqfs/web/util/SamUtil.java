...
public class SamUtil {
    ...
    public static String getMediaTypeString(int mValue) {
        ...
        switch (mValue) {
            ...
            case BaseDevice.MTYPE_STK_SL3000:
                mediaTypeString = getResourceString("media.type.stk.sl3000");
                break;
            ...
            case BaseDevice.MTYPE_SPECTRA_LOGIC_PYTHON:
                mediaTypeString = getResourceString("media.type.spcpyth");
                break;
            default:
    ...
    public static int getMediaType(String mValue) {
        ...
        } else if (mValue.equals(getResourceString("media.type.stk.sl3000"))) {
        ...
        } else if (mValue.equals(getResourceString("media.type.spcpyth"))) {
            mediaType = BaseDevice.MTYPE_SPECTRA_LOGIC_PYTHON;
        }
