...
// ident	$Id: AlarmsServlet.java,v 1.10 2008/12/16 00:10:53 am143972 Exp $
...
/**
 * This Servlet class is for alarms module
 */
public class AlarmsServlet extends AppServletBase {
    ...
    /**
     * Package name for the alarms servlet
     */
    public static String PACKAGE_NAME =
        getPackageName(AlarmsServlet.class.getName());

    /**
     * Constructor
     */
    public AlarmsServlet() {
        super();
    }
