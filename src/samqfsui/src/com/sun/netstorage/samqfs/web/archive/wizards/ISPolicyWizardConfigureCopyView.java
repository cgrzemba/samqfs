...
// ident	$Id: ISPolicyWizardConfigureCopyView.java,v 1.10 2008/12/16 00:12:08 am143972 Exp $
...
/**
 * A ContainerView object for the pagelet for configure copy in New Policy
 * Wizard.
 *
 */
public class ISPolicyWizardConfigureCopyView
    extends RequestHandlingViewBase implements CCWizardPage {

    // The "logical" name for this page.
    public static final String PAGE_NAME = "ISPolicyWizardConfigureCopyView";
     ...
     */
    public ISPolicyWizardConfigureCopyView(View parent, Model model) {
        this(parent, model, PAGE_NAME);
    }

    public ISPolicyWizardConfigureCopyView(
    ...
    protected View createChild(String name) {
        ...
        if (name.equals(ALERT)) {
            ...
            throw new IllegalArgumentException(
                "ISPolicyWizardConfigureCopyView : Invalid child name [" +
                    name + "]");
        }
    ...
    public String getPageletUrl() {
        ...
        String url = null;
        if (!prevErr) {
            url = "/jsp/archive/wizards/ISPolicyWizardConfigureCopy.jsp";
        } else {
        ...
        if (errorString != null) {
            if (errorString.equals(Constants.Wizard.WIZARD_ERROR_YES)) {
                ...
                SamUtil.setErrorAlert(
                    this,
                    ISPolicyWizardConfigureCopyView.ALERT,
    ...
    private void populateDropDownMenus(SamWizardModel wizardModel) {
        ...
        try {
            ...
            // TODO:
            // Need to file a bug that getAllVSNPools SHOULD NOT
    ...
    private void populateCopyInformation(SamWizardModel wizardModel) {
        ...
        HashMap copyNumberHashMap =
            (HashMap) wizardModel.getValue(ISPolicyWizardImpl.COPY_HASHMAP);
    ...
    private void setErrorLabel(SamWizardModel wizardModel) {
        String labelName = (String) wizardModel.getValue(
            ISPolicyWizardImpl.VALIDATION_ERROR);
    ...
    private Integer getCopyNumber(SamWizardModel wizardModel) {
        return (Integer) wizardModel.getValue(
            ISPolicyWizardImpl.CURRENT_COPY_NUMBER);
    }
