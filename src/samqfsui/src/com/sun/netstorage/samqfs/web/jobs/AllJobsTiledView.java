...
// ident	$Id: AllJobsTiledView.java,v 1.11 2008/03/17 14:43:37 am143972 Exp $
...
/**
 * Tiled View for the 'All Jobs' Action Table
 */
public class AllJobsTiledView extends RequestHandlingTiledViewBase {
     ...
     */
    public AllJobsTiledView(View parent, AllJobsModel model, String name) {
        super(parent, name);
        TraceUtil.initTrace();
        this.model = model;
        registerChildren();
