...
// ident	$Id: HistorianTiledView.java,v 1.23 2008/12/16 00:12:13 am143972 Exp $
...
/**
 *  This is the TiledView class for Historian Page. This is used to identify
 *  if an alarm HREF link is needed. Also this tiledview class is needed to
 *  avoid concurrency issue.
 */

public class HistorianTiledView extends RequestHandlingTiledViewBase {
    // Child view names (i.e. display fields).
    public static final String CHILD_VSN_HREF = "VSNHref";
    public static final String CHILD_MEDIA_HREF = "MediaHref";
    public static final String CHILD_MEDIA_ATTRIBUTES_TEXT =
        "MediaAttributesText";
     ...
     */
    public HistorianTiledView
        (View parent, HistorianModel model, String name) {
        super(parent, name);
        TraceUtil.initTrace();
