...
// ident	$Id: AllJobsView.java,v 1.21 2008/05/16 18:38:55 am143972 Exp $
...
/**
 * Creates the 'All Jobs' Action Table and provides
 * handlers for the links within the table.
 */
public class AllJobsView extends CommonTableContainerView {

    private String selectedFilter;
    private AllJobsModel model;
    private ArrayList updatedModel = new ArrayList();

    public static final String CHILD_FILTERMENU_HREF = "FilterMenuHref";

    public static final String CHILD_TILED_VIEW = "AllJobsTiledView";
    private String serverName;

    public AllJobsView(View parent, String name, String serverName) {
        super(parent, name);
        TraceUtil.initTrace();
        TraceUtil.trace3("Entering");
        CHILD_ACTION_TABLE = "AllJobsTable";
        this.serverName = serverName;
        model = new AllJobsModel(serverName);
        registerChildren();
    ...
    public void registerChildren() {
        ...
        registerChild(CHILD_TILED_VIEW, AllJobsTiledView.class);
    ...
    public View createChild(String name) {
        ...
        if (name.equals(CHILD_FILTERMENU_HREF)) {
            ...
            TraceUtil.trace3("Exiting");
            return new AllJobsTiledView(this, model, name);
        } else {
    ...
    public void handleFilterMenuHrefRequest(RequestInvocationEvent event)
        ...
        if (selectedType != null)  {
            parentBean.setPageSessionAttribute(
                Constants.PageSessionAttributes.ALLJOBSFILTER_MENU,
                selectedType);
        } else {
            parentBean.setPageSessionAttribute(
                Constants.PageSessionAttributes.ALLJOBSFILTER_MENU, "");
        ...
        if (selectedType != null) {
            if (!selectedType.equals(CCActionTable.FILTER_ALL_ITEMS_OPTION)) {
                if (selectedType.equals("1")) {
                    ...
                    selectedFilter = new String("Jobs.jobType4");
    ...
    public void beginDisplay(DisplayEvent event)
        ...
        // disable table selection if no sam control authorization
    ...
    public void handleButton0Request(RequestInvocationEvent event)
        ...
        AllJobsModel allModel = (AllJobsModel) actionTable.getModel();

        Integer [] selectedRows = allModel.getSelectedRows();

        if (selectedRows.length == 0) {
            TraceUtil.trace3("AllJobsView: selectedRows.length is 0");
        }
        ...
        try {
            for (int i = 0; i < selectedRows.length; i++) {
                ...
                allModel.setRowIndex(row);
                String jobId = (String) allModel.getValue("JobHidden");
