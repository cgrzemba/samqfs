...
// ident	$Id: CurrentJobsTiledView.java,v 1.12 2008/03/17 14:43:37 am143972 Exp $
...
/**
 * Tiled View for the Current Jobs Action Table
 */
public class CurrentJobsTiledView extends RequestHandlingTiledViewBase {
     ...
     */
    public CurrentJobsTiledView(
        View parent, CurrentJobsModel model, String name) {
    ...
    public void handleJobIdHrefRequest(RequestInvocationEvent event)
        ...
        TraceUtil.trace3("JobIdHref = " + s);

        // if this is a staging job, go to a page other than the
        // JobsDetails page, as the staging pages will be structured
        // differently because of the Large Data Set issue.  The action
        // table will not be in the property sheet, and a container view
        // will be used.
