...
// ident	$Id: FileMatchCriteriaTiledView.java,v 1.11 2008/12/16 00:10:55 am143972 Exp $
...
public class FileMatchCriteriaTiledView extends CommonTiledViewBase {
    public FileMatchCriteriaTiledView(View parent,
    ...
    public void handleCriteriaDetailsHrefRequest(RequestInvocationEvent evt)
        ...
        String cn = getDisplayFieldStringValue("CriteriaNumber");
        Integer criteriaNumber = new Integer(cn);

        TraceUtil.trace2("criteriaNumber = " + criteriaNumber);
