...
// ident	$Id: LibraryFaultsSummaryTiledView.java,v 1.10 2008/03/17 14:43:39 am143972 Exp $
 ...
 *
 */
public class LibraryFaultsSummaryTiledView
     ...
     */
    public LibraryFaultsSummaryTiledView
        (View parent, LibraryFaultsSummaryModel model, String name) {
        super(parent, name);
        TraceUtil.initTrace();
        this.model = model;
        registerChildren();
