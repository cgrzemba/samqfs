...
// ident	$Id: ISPolicyWizardSummaryView.java,v 1.8 2008/05/16 18:38:52 am143972 Exp $
 ...
 *
 */
public class ISPolicyWizardSummaryView extends RequestHandlingViewBase
    implements CCWizardPage {

    // The "logical" name for this page.
    public static final String PAGE_NAME = "ISPolicyWizardSummaryView";

    // Child view names (i.e. display fields).
    public static final String LABEL = "Label";
    public static final String DATA_CLASS_NAME = "DataClassName";
    public static final String DESCRIPTION = "PolicyDescription";
     ...
     */
    public ISPolicyWizardSummaryView(View parent, Model model) {
        this(parent, model, PAGE_NAME);
    }

    public ISPolicyWizardSummaryView(
        ...
        if (name.equals(ALERT)) {
           child = new CCAlertInline(this, name, null);
            ...
            throw new IllegalArgumentException(
                "ISPolicyWizardSummaryView : Invalid child name [" +
                name + "]");
        }
    ...
    public void beginDisplay(DisplayEvent event) throws ModelControlException {
        ...
        ((CCStaticTextField) getChild(DATA_CLASS_NAME)).setValue(
            (String) wizardModel.getValue(
                ISPolicyWizardImpl.SELECTED_DATA_CLASS));
        ...
        if (error != null) {
            if (error.equals(Constants.Wizard.WIZARD_ERROR_YES)) {
                ...
                SamUtil.setErrorAlert(
                    this,
                ISPolicyWizardSummaryView.ALERT,
    ...
    private void constructCopyInfoString(SamWizardModel wizardModel) {
        int totalCopies =
            ((Integer) wizardModel.getValue(
                ISPolicyWizardImpl.TOTAL_COPIES)).intValue();
        if (totalCopies == 0) {
            return;
        }
