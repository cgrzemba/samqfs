...
// ident	$Id: NewDataClassWizardConfigureCopy.js,v 1.5 2008/12/16 00:10:37 am143972 Exp $

    var NOVAL = "-999";
    var NOVAL_LABEL = "--";

    function handleExpireCheckBoxClick(field) {
        var prefix = "WizardWindow.Wizard.NewDataClassWizardConfigureCopyView.";
    ...
    function populateScratchPoolDropDown() {
        var prefix   =
            "WizardWindow.Wizard.NewDataClassWizardConfigureCopyView.";
