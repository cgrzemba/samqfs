...
<!-- $Id: EnableRecoveryPointJobDetails.jsp,v 1.3 2008/12/16 00:10:47 am143972 Exp $ -->
...
<ui:body>
<ui:form id="EnableRecoveryPointJobDetailsForm">
    ...
    <h:panelGrid columns="2" style="margin-left:20px" cellspacing="10">
        ...
        <ui:staticText id="jobId" text="#{JobController.enableRecoveryPointJob.jobId}"/>

        <ui:label for="type" text="#{samBundle['job.details.type']}"/>
        <ui:staticText id="type" text="#{JobController.enableRecoveryPointJob.type}" converter="JobTypeConverter"/>

        <ui:label for="initTime" text="#{samBundle['job.details.initializationtime']}"/>
        <ui:staticText id="initTime" text="#{JobController.enableRecoveryPointJob.startTime}">
            <f:convertDateTime dateStyle="medium" timeStyle="medium"/>
        </ui:staticText>

        <ui:label for="fsname" text="#{samBundle['job.details.fsname']}"/>
        <ui:staticText id="fsname" text="#{JobController.enableRecoveryPointJob.fileSystemName}"/>

        <ui:label for="snapshotfile" text="#{samBundle['job.details.snapshot']}"/>
        <ui:staticText id="snapshotfile" text="#{JobController.enableRecoveryPointJob.dumpFileName}"/>
    </h:panelGrid>
