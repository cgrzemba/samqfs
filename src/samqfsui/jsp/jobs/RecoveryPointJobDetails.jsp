...
<!-- $Id: RecoveryPointJobDetails.jsp,v 1.2 2008/05/16 19:39:21 am143972 Exp $ -->
...
<ui:body>
<ui:form id="RecoveryPointJobDetailsForm">
    ...
    <h:panelGrid columns="2" style="margin-left:20px" cellspacing="10">
        ...
        <ui:staticText id="jobId" text="#{JobController.recoveryPointJob.jobId}"/>

        <ui:label for="type" text="#{samBundle['job.details.type']}"/>
        <ui:staticText id="type" text="#{JobController.recoveryPointJob.type}" converter="JobTypeConverter"/>

        <ui:label for="initTime" text="#{samBundle['job.details.initializationtime']}"/>
        <ui:staticText id="initTime" text="#{JobController.recoveryPointJob.startTime}">
            <f:convertDateTime dateStyle="medium" timeStyle="medium"/>
        </ui:staticText>

        <ui:label for="fsname" text="#{samBundle['job.details.fsname']}"/>
        <ui:staticText id="fsname" text="#{JobController.recoveryPointJob.fileSystemName}"/>

        <ui:label for="snapshotfile" text="#{samBundle['job.details.snapshot']}"/>
        <ui:staticText id="snapshotfile" text="#{JobController.recoveryPointJob.dumpFileName}"/>
    </h:panelGrid>
