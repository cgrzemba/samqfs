...
// ident	$Id: NewWizardSharedQFSSummary.jsp,v 1.7 2008/05/16 19:39:20 am143972 Exp $
...
<table border="0" cellspacing="10" cellpadding="0">
    <tbody>
        ...
        <tr>
            <td>
                <cc:label name="Label" styleLevel="2"
                          elementName="potentialMetadataServerTextField"
                          defaultValue="FSWizard.new.potentialMetadataServerLabel"
                          bundleID="samBundle" />
            </td>
            <td>
                <cc:text name="potentialMetadataServerTextField"
                         bundleID="samBundle" />
            </td>
        </tr>
        <tr>
            <td>
                <cc:label name="Label" styleLevel="2"
                          elementName="clientTextField"
                          defaultValue="FSWizard.new.clientLabel"
                          bundleID="samBundle" />
            </td>
            <td>
                <cc:text name="clientTextField"
                         bundleID="samBundle" />
            </td>
        </tr>
        <tr>
            <td>
                <cc:label name="Label" styleLevel="2"
                          elementName="primaryIP"
                          defaultValue="FSWizard.new.primaryIPLabel"
                          bundleID="samBundle" />
            </td>
            <td>
                <cc:text name="primaryIP"
                         bundleID="samBundle" />
            </td>
        </tr>
        <tr>
            <td>
                <cc:label name="Label" styleLevel="2"
                          elementName="secondaryIP"
                          defaultValue="FSWizard.new.secondaryIPLabel"
                          bundleID="samBundle" />
            </td>
            <td>
                <cc:text name="secondaryIP"
                         bundleID="samBundle" />
            </td>
        </tr>
