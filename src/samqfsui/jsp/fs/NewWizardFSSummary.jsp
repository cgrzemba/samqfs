...
// ident	$Id: NewWizardFSSummary.jsp,v 1.20 2008/12/16 00:10:46 am143972 Exp $
...
<table border="0" cellspacing="10" cellpadding="0">
    <tbody>
        ...
        <tr>
            <td>
                <cc:label name="selectedNodesLabel"
                          elementName="selectedNodes"
                          defaultValue="FSWizard.new.cluster.nodes"
                          bundleID="samBundle"/>
                <cc:label name="bootTimeLabel" styleLevel="2"
                   elementName="bootTimeCheckBox"
                   defaultValue="FSWizard.new.mountBootLabel"
                   bundleID="samBundle" />
            </td>
            <td>
                <cc:selectablelist name="selectedNodes"
                                   bundleID="samBundle"/>
