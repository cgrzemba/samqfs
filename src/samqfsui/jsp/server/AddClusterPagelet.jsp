...
// ident	$Id: AddClusterPagelet.jsp,v 1.4 2008/03/17 14:40:39 am143972 Exp $
--%>
...
<tr>
    ...
    <td>
        <cc:text
            name="StaticText"
            defaultValue="AddCluster.instruction"
            escape="false"
            bundleID="samBundle" />
    <td>
</tr>
...
<cc:actiontable
    name="AddClusterTable"
    bundleID="samBundle"
    title="AddCluster.tabletitle"
