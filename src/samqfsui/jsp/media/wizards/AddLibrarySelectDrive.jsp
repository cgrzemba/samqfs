...
// ident	$Id: AddLibrarySelectDrive.jsp,v 1.6 2008/12/16 00:10:49 am143972 Exp $
--%>
...
<script type="text/javascript"
    src="/samqfsui/js/media/wizards/AddLibrarySelectDrive.js"></script>
<script type="text/javascript">
...
<tr>
    <td valign="center" align="left" rowspan="1" colspan="1">
        <cc:actiontable
            name="SelectMediaTypeTable"
            bundleID="samBundle"
            title="AddLibrarySelectDrive.tabletitle"
