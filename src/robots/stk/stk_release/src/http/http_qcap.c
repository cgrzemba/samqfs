...
/** All rights reserved.                                             */
/**                                                                  */
/** File Name:      http_qcap.c                                      */
/** Description:    t_http server executable XAPI query_cap          */
/**                 response generator.                              */
/**                                                                  */
/** Change History:                                                  */
/**==================================================================*/
...
/***FUNCTION PROLOGUE*************************************************/
/**                                                                  */
/** Function Name: http_qcap                                         */
/** Description:   t_http server executable XAPI query_cap           */
/**                response generator.                               */
/**                                                                  */
/***END PROLOGUE******************************************************/
#undef SELF
#define SELF "http_qcap"
              ...
              void           *pRequestXmlparse)
{
    ...
    /*****************************************************************/
    /* We assume that the query_cap request is a query request       */
    /* to return all cap(s).                                         */
    /*****************************************************************/
