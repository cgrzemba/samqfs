...
/** All rights reserved.                                             */
/**                                                                  */
/** File Name:      http_qmedia.c                                    */
/** Description:    t_http server executable XAPI query_media        */
/**                 response generator.                              */
/**                                                                  */
/** Change History:                                                  */
/**==================================================================*/
...
/***FUNCTION PROLOGUE*************************************************/
/**                                                                  */
/** Function Name: http_qmedia                                       */
/** Description:   t_http server executable XAPI query_media         */
/**                response generator.                               */
/**                                                                  */
/***END PROLOGUE******************************************************/
#undef SELF
#define SELF "http_qmedia"
                ...
                void           *pRequestXmlparse)
{
    ...
    /*****************************************************************/
    /* Any query_media request received by the HTTP server will      */
    /* always return the complete query_media response.              */
    /*****************************************************************/
