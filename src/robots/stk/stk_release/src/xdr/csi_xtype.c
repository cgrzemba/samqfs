...
#ifndef lint
static char SccsId[] = "@(#)csi_xtype.c	5.4 11/11/93 ";
#endif
/*
 ...
 * Description:
 *
 *      Routine serializes/deserializes TYPE.
 *
 * Return Values:
 *
...
static char     *st_module = "csi_xtype()";
...
)
{
    ...
    if TRACE(CSI_XDR_TRACE_LEVEL)
        cl_trace(st_module,                     /* routine name */
                 ...
                 (unsigned long) type);         /* argument list */
#endif /* DEBUG */

    /* translate type */
    if (!xdr_enum(xdrsp, (enum_t *)type)) {
