...
uint64_t default_cap[STK_MEDIA_CAP_COUNT] = {
	...
	(1024 * 1024 * 1000),		/* T10000T2 */
        ...
        ((uint64_t)1024 * 1024 * 1024 *12),   	/* IBM-LTO8, LTO-12T */
        ((uint64_t)1024 * 1024 * 1024 *12),   	/* IBM-LTO8, LTO-12W */
        ((uint64_t)1024 * 1024 * 5000),   	/* T10000TA */
        ((uint64_t)1024 * 1024 * 1024 * 9),   	/* LTO-9T */
        ((uint64_t)1024 * 1024 * 1024 * 18),   	/* IBM-LTO9, LTO-18T */
        ((uint64_t)1024 * 1024 * 1024 * 18),   	/* IBM-LTO9, LTO-18W */
};
