...
// ident	$Id: TestFSumount.java,v 1.10 2008/12/16 00:08:58 am143972 Exp $
...
public class TestFSumount {
    ...
    public static void main(String args[]) {
        ...
        try {
           ...
           System.out.println("Calling native FS.umount(ctx," + args[0] + ")");
           FS.umount(new Ctx(c), args[0]);
